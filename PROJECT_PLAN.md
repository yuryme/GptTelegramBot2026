...
- [x] Добавить единые правила кодировки в `.editorconfig` (`utf-8`).
- [x] Вынести пользовательские русские строки из Python-кода в `locales/ru.json`.
- [x] Добавить легковесный i18n-слой для получения строк по ключам.
- [x] Перевести Telegram-обработчики на ключи локализации.
- [x] Убрать поврежденные prompt-строки из `LLMService` и заменить безопасными инструкциями.
- [x] Добавить локальную автоматическую проверку кодировки/mojibake (`scripts/check_encoding.py`).
